...
//TODO: Step 8 - Create a method called getStory() that returns the first storyTitle from _storyData.
  String? getStory() {
    return _storyData[_storyNumber].storyTitle; //null check operator
  }
...
//TODO: Step 17 - Create a method called nextStory(), it should not have any outputs but it should have 1 input called choiceNumber which will be the choice number (int) made by the user.
  void nextStory(int userchoiceNumber) {
    if (userchoiceNumber == 1 && _storyNumber == 0) {
      _storyNumber = 2;
    } else if (userchoiceNumber == 2 && _storyNumber == 0) {
      _storyNumber = 1;
    } else if (userchoiceNumber == 1 && _storyNumber == 1) {
      _storyNumber = 2;
    } else if (userchoiceNumber == 2 && _storyNumber == 1) {
      _storyNumber = 3;
    } else if (userchoiceNumber == 1 && _storyNumber == 2) {
      _storyNumber = 5;
    } else if (userchoiceNumber == 2 && _storyNumber == 2) {
      _storyNumber = 4;
